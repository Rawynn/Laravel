                    ...
                    <div class="people-wrapper">
                        ...
                        <div class="person-card m-3">
                            <div class="person-card-content text-center">
                                <h2 class="fw-bold mb-4" x-text="person.name"></h2>
                                <h3>Birth year: <span x-text="person.birth_year"></span></h3>
                                <h3>Gender: <span x-text="person.gender"></span></h3>
                                <h3>Height: <span x-text="person.height"></span></h3>
                                <h3>Mass: <span x-text="person.mass"></span></h3>
                            </div>
                        </div>
                        </template>
                        </div>
